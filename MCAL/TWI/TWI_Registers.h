...
#define _TWCR    (*((volatile uint8_t)0x56))
#define _TWIE    0
#define _TWEN    2
#define _TWWC    3
#define _TWSTO   4
...
#define _TWSR    (*((volatile uint8_t)0x21))
#define _TWPS0   0
#define _TWPS1   1
#define _TWS3    3
#define _TWS4    4
...
#define _TWBR    (*((volatile uint8_t)0x20))

// _TWI Address Register
#define _TWAR    (*((volatile uint8_t)0x22))
#define _TWA0    1
#define _TWA1    2
#define _TWA2    3
#define _TWA3    4
...
// _TWI Data Register
#define _TWDR    (*((volatile uint8_t)0x23))
